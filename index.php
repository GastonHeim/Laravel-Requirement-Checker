...
$laravel42Obs = 'dimulai dari PHP 5.5, beberapa OS distribusi mungkin dibutuhkan dan kamu membutuhkan install PHP JSON extension.
ketika menggunakan Ubuntu, lakukan dengan cara apt-get install php5-json.';
$laravel50Obs = 'PHP harus lebih < 7. As of PHP 5.5, some OS distributions may require you to manually install the PHP JSON extension.
